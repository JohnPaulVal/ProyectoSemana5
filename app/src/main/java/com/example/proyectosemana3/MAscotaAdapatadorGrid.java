...
public class MAscotaAdapatadorGrid extends RecyclerView.Adapter<MAscotaAdapatadorGrid.MascotaViewHolderGrid> {

    ArrayList<Mascota>mascotas;

    public MAscotaAdapatadorGrid(ArrayList<Mascota>mascotas){
    ...
    public MascotaViewHolderGrid onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.carview_mascota_grid,parent,false);
    ...
    public void onBindViewHolder(@NonNull MascotaViewHolderGrid holder, int position) {
        ...
        holder.tvRaitingCV.setText(mascota.getValoreRaiting()+" ");
